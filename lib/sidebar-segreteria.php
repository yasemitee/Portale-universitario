<div class="sidebar col-auto col-sm-3 col-md-3 col-lg-2 px-sm-1 px-0 position-fixed" id="sidebar">
  <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
    <a href="segreteria.php" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <span class="fs-5 d-none d-sm-inline mt-2" style="letter-spacing: 2px;">Portale UNI</span>
    </a>
    <ul class=" nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">
      <li class="nav-item">
        <a href="segreteria.php" class="nav-link align-middle pt-3 px-0 pt-5 text-white hover-underline-animation">
